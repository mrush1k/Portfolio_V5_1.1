      ...
      >
        <div className="container px-[1%] grid grid-cols-1 gap-12">
          <div
            ...
            className="bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl p-5 py-10 sm:p-10 hover:shadow-[#6366f1]/10 mx-auto max-w-3xl"
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Interested in working together? I'm open to exciting projects,
                  job opportunities, and tech discussions—let's talk!
                </p>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <input
                type="hidden"
                name="access_key"
                value="6c498294-83fa-4ed9-a326-a0201bd797c4"
              />
              ...
              <button
                ...
                data-aos="fade-up"
                data-aos-delay="400"
                className="w-full bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-white py-4 rounded-xl font-semibold flex items-center justify-center gap-2 hover:scale-[1.02] transition-all"
              >
